...
saidjah-a5.tex: index.html Makefile ../latehxigu.xslt eo.sed  titolpag.tex revisio
	xsltproc ../latehxigu.xslt $<  | sed -f eo.sed | konwert utf8-tex > $@

saidjah-a4.tex: index.html Makefile ../latehxigu.xslt eo.sed titolpag.tex revisio
